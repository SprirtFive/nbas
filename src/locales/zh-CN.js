...
export default {
  'navbar.lang': 'English',
  'menu.home': '首页',
  'menu.piccdashboard': '经营管理一览',
  'menu.piccdashboard.seniormanager': '公司全景视角',
  'menu.dashboard': 'Dashboard',
  'menu.dashboard.analysis': '公司全景视角',
  'menu.piccdashboard.monitor': '车险部视角',
  'menu.dashboard.monitor': '车险部视角',
  ...
  'app.SeniorManager.test': '工专路 {no} 号店',
  'app.SeniorManager.introduce': '指标说明',
  'app.SeniorManager.total-sales': '总销售额',
  'app.SeniorManager.day-sales': '日销售额',
  'app.SeniorManager.visits': '访问量',
  'app.SeniorManager.visits-trend': '访问量趋势',
  'app.SeniorManager.visits-ranking': '门店访问量排名',
  'app.SeniorManager.day-visits': '日访问量',
  'app.SeniorManager.week': '周同比',
  'app.SeniorManager.day': '日同比',
  'app.SeniorManager.payments': '支付笔数',
  'app.SeniorManager.conversion-rate': '转化率',
  'app.SeniorManager.operational-effect': '运营活动效果',
  'app.SeniorManager.sales-trend': '销售趋势',
  'app.SeniorManager.sales-ranking': '门店销售额排名',
  'app.SeniorManager.all-year': '全年',
  'app.SeniorManager.all-month': '本月',
  'app.SeniorManager.all-week': '本周',
  'app.SeniorManager.all-day': '今日',
  'app.SeniorManager.search-users': '搜索用户数',
  'app.SeniorManager.per-capita-search': '人均搜索次数',
  'app.SeniorManager.online-top-search': '线上热门搜索',
  'app.SeniorManager.the-proportion-of-sales': '销售额类别占比',
  'app.SeniorManager.channel.all': '全部渠道',
  'app.SeniorManager.channel.online': '线上',
  'app.SeniorManager.channel.stores': '门店',
  'app.SeniorManager.sales': '销售额',
  'app.SeniorManager.traffic': '客流量',
  'app.SeniorManager.table.rank': '排名',
  'app.SeniorManager.table.search-keyword': '数据产品名称',
  'app.SeniorManager.table.users': '用户数',
  'app.SeniorManager.table.weekly-range': '周涨幅',
