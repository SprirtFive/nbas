export default {
  'navbar.lang': '中文',
  'menu.home': 'Home',
  'menu.piccdashboard': 'Dashboard',
  'menu.dashboard': 'Dashboard',
  'menu.piccdashboard.seniormanager': 'SeniorManager',
  ...
  'app.SeniorManager.test': 'Gongzhuan No.{no} shop',
  'app.SeniorManager.introduce': 'Introduce',
  'app.SeniorManager.total-sales': 'Total Sales',
  'app.SeniorManager.day-sales': 'Day Sales',
  'app.SeniorManager.visits': 'Visits',
  'app.SeniorManager.visits-trend': 'Visits Trend',
  'app.SeniorManager.visits-ranking': 'Visits Ranking',
  'app.SeniorManager.day-visits': 'Day Visits',
  'app.SeniorManager.week': 'Week Ratio',
  'app.SeniorManager.day': 'Day Ratio',
  'app.SeniorManager.payments': 'Payments',
  'app.SeniorManager.conversion-rate': 'Conversion Rate',
  'app.SeniorManager.operational-effect': 'Operational Effect',
  'app.SeniorManager.sales-trend': 'Stores Sales Trend',
  'app.SeniorManager.sales-ranking': 'Sales Ranking',
  'app.SeniorManager.all-year': 'All Year',
  'app.SeniorManager.all-month': 'All Month',
  'app.SeniorManager.all-week': 'All Week',
  'app.SeniorManager.all-day': 'All day',
  'app.SeniorManager.search-users': 'Search Users',
  'app.SeniorManager.per-capita-search': 'Per Capita Search',
  'app.SeniorManager.online-top-search': 'Online Top Search',
  'app.SeniorManager.the-proportion-of-sales': 'The Proportion Of Sales',
  'app.SeniorManager.channel.all': 'ALL',
  'app.SeniorManager.channel.online': 'Online',
  'app.SeniorManager.channel.stores': 'Stores',
  'app.SeniorManager.sales': 'Sales',
  'app.SeniorManager.traffic': 'Traffic',
  'app.SeniorManager.table.rank': 'Rank',
  'app.SeniorManager.table.search-keyword': 'Keyword',
  'app.SeniorManager.table.users': 'Users',
  'app.SeniorManager.table.weekly-range': 'Weekly Range',
